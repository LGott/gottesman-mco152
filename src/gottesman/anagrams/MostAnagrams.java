...
public class MostAnagrams {
	...
	public ArrayList<ArrayList<String>> getAnagrams(String fileName) throws IOException {
		...
		// Create a new HashMap where the value of each key (key =specific
		// letters), is an
		...
		// Place each word into a char array in order to sort the letters
		// alphabetically.
		...
		// If a value contains only one word in it's list, then it obviously
		// does not have any anagrams, so we do not
		// want to return those words as part of the list, and therefore return
		// only values that are greater than 1
